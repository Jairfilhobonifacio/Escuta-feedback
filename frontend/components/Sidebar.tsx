...
type NavItem = { href: string; label: string; ico: ReactNode; feature?: boolean };
...
/* Navegação agrupada por intenção do usuário (mantém TODOS os itens e rotas):
     ...
     OPERAR    — onde se age e se conecta (execução + infra do WhatsApp)
   Os rótulos são sutis; a hierarquia ajuda a achar a tela certa mais rápido. */
const groups: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        // Conexão (pareamento do WhatsApp): celular com sinal de pareamento —
        // distingue-se de "Contatos"/"Chat" por evocar o aparelho + a conexão.
        href: "/conexao",
        label: "Conexão",
        ico: (
          <Ico>
            ...
            <path d="M11.2 11a1.2 1.2 0 0 1 1.6 0" />
          </Ico>
        ),
      },
      {
